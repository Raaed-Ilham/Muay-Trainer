...
import com.example.visiontest.ML_Managers.vision.GraphicOverlay.Graphic;
...
public class PoseGraphic extends GraphicOverlay.Graphic {
  ...
  public void draw(Canvas canvas) {
    ...
    for (int i = 0; i < poseClassification.size(); i++) {
      ...
      canvas.drawText(poseClassification.get(i), classificationX, classificationY, classificationTextPaint);
