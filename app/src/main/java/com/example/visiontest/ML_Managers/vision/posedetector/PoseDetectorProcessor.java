...
package com.example.visiontest.ML_Managers.vision.posedetector;
...
import com.example.visiontest.ML_Managers.vision.VisionProcessorBase;
            ...
            task -> {
              ...
              if (runClassification) {
                if (poseClassifierProcessor == null) {
                  poseClassifierProcessor = new PoseClassifierProcessor(context, isStreamMode,activity,selected_pose,userID);
                }
        ...
        .continueWith(
            ...
            task -> {
              ...
              if (runClassification) {
                ...
                classificationResult = poseClassifierProcessor.getPoseResult(pose);
                //poseClassifierProcessor.dutchDrillReps;
              }
              return new PoseWithClassification(pose, classificationResult);
